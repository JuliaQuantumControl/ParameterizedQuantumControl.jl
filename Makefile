...
clean:  ## Clean up build/doc/testing artifacts
	...
	rm -f test/LocalPreferences.toml docs/LocalPreferences.toml
...
distclean: clean  ## Restore to a clean checkout state
	...
	for folder in test/data docs/data; do \
	    if [ -d $$folder ]; then find $$folder -mindepth 1 -maxdepth 1 ! -name ".*" -exec rm -rf {} +; fi; \
	done
